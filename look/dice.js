...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e31e11b8');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e31e11b8');}
...
var brandEl=document.querySelector('.rl-brand-e31e11b8');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
